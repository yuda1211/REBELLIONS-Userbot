...
async def _(event):
   ...
   # input_str = event.pattern_match.group(1)
    ...
    animation_chars = [
        ...
        "INFO - REBELLIONS-Project: Logged in as 557667062",
        "INFO - REBELLIONS-Project: Successfully...",
        "919852+00:00 app[worker.1]: 919 - REBELLIONS-Project -",
        "INFO - ⚡REBELLIONS-Project⚡ ⚙️ V5.0 [TELAH DIAKTIFKAN!]",
        "**Build Succeeded**"
