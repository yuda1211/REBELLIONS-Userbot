...
PM_PERMIT_PIC = os.environ.get(
    "PM_PERMIT_PIC",
    None) or "https://telegra.ph/file/5059b1016bccac482f90b.jpg"
...
async def check_alive():
    await bot.send_message(BOTLOG_CHATID, "```𝘊𝘰𝘯𝘨𝘳𝘢𝘵𝘴𝘴... ⚡REBELLIONS⚡ Has Been Active!!```")
    return
    ...
    try:
        ...
        async def handler(event):
            if event.message.from_id != uid:
                await event.reply("⚡REBELLIONS⚡, Buat Userbot Mu Sendiri [Tekan Disini](https://yud023.github.io/REBELLIONS-Userbot)")
            else:
